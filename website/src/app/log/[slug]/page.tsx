      ...
      <main className="pt-20">
        ...
        <Section>
          <div className={slug === "fiordland-stewart-island-expedition-plan" ? "" : "grid lg:grid-cols-3 gap-12"}>
                ...
                <>
                  <div className="prose prose-invert prose-lg max-w-3xl mb-8">
                    ...
                    <p className="text-mist">
                      <Link href="/voyages/fiordland-2026" className="text-copper-accent hover:text-copper-light transition-colors">
                        View the Fiordland & Stewart Island 2026 voyage →
                      </Link>
                    </p>
                  </div>
                  <ExpeditionSchedule />
            ...
            {/* Sidebar - hide for expedition plan post */}
            {slug !== "fiordland-stewart-island-expedition-plan" && (
              <aside className="lg:col-span-1">
                <div className="sticky top-24 space-y-8">
                  {/* Location Card */}
