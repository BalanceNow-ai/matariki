...
const crewInfoPages: CrewInfoPage[] = [
  {
    title: "Pre-Reading for New Crew",
    description:
      "Essential pre-reading for first-time crew members preparing to join an Oyster 68 for an offshore passage.",
    href: "/crew-info/crew-orientation",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
